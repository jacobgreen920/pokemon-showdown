export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	vulpix: {
		...
		abilities: { 0: "Flash Fire", H: "Desolate Land" },
		heightm: 0.6,
		weightkg: 9.9,
		color: "Brown",
		evos: ["Ninetales"],
	...
	politoed: {
		...
		abilities: { 0: "Water Absorb", 1: "Damp", H: "Primordial Sea" },
		heightm: 1.1,
		weightkg: 33.9,
		color: "Green",
		prevo: "Poliwhirl",
	...
	pelipper: {
		...
		abilities: { 0: "Keen Eye", 1: "Primordial Sea", H: "Rain Dish" },
		heightm: 1.2,
		weightkg: 28,
		color: "Yellow",
		prevo: "Wingull",
	...
	torkoal: {
		...
		abilities: { 0: "White Smoke", 1: "Desolate Land", H: "Shell Armor" },
		heightm: 0.5,
		weightkg: 80.4,
		color: "Brown",
		eggGroups: ["Field"],
