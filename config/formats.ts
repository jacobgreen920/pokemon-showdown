...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		ruleset: [
			'Standard NatDex',
			'!Species Clause', 'Forme Clause', '!Sleep Clause Mod', 'Sleep Moves Clause', 'Terastal Clause', 'Mega Rayquaza Clause',
		],
		banlist: [
	...
	},
	{
		...
		banlist: [
			...
			'Power Construct', 'Moody', 'Shadow Tag', 'Focus Band', 'King\'s Rock', 'Quick Claw', 'Razor Fang', 'Smooth Rock', 'Terrain Extender', 'Baton Pass',
		],
	},
	{
